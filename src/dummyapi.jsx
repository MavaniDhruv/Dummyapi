...
function Dummyapi() {
    ...
    // const idProd = useSelector((state) => state.counter.idProd)
                        ...
                        <table width={258}>
                            {
                                cate.map((item) => {
                                    return (
                                        <tr>
                                            <th className='category' onClick={() => { cateProduct(item.name) }}>{item.name}</th>
                                        </tr>
                                    )
                                })
                            }
